...
class Plugin_Name_Admin {
	...
	private function __construct() {
		...
		// Add an action link pointing to the options page. TODO: Rename "nds-wp-podcasting.php" to the name your plugin
		$plugin_basename = plugin_basename( plugin_dir_path( __FILE__ ) . 'nds-wp-podcasting.php' );
